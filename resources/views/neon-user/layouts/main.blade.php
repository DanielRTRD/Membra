...
<head>
	...
	<title>Neon | Horizontal Menu Boxed</title>

	<link rel="stylesheet" href="{{ asset('js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/font-icons/entypo/css/entypo.css') }}">
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/bootstrap.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/neon-core.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/neon-theme.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/neon-forms.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/css/custom.css') }}">

	<script src="{{ asset('/neon-user/js/jquery-1.11.0.min.js') }}"></script>
	<script>$.noConflict();</script>

	<!--[if lt IE 9]><script src="{{ asset('/neon-user/js/ie8-responsive-file-warning.js') }}"></script><![endif]-->
	...
	<header class="navbar navbar-fixed-top"><!-- set fixed position by adding class "navbar-fixed-top" -->
		...
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				<a href="index.html">
					<img src="/neon-user/images/logo@2x.png" width="88" alt="" />
				</a>
			</div>
		...
		<li class="active">
			<a href="#">
				<span class="image pull-right">
					<img src="/neon-user/images/thumb-1.png" alt="" class="img-circle" />
				</span>
	...
	<div class="col-sm-9">
		...
		<div class="tile-group">
			...
			<div class="tile-left">
				...
				<div class="tile-entry">
					<img src="/neon-user/images/sample-al.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="/neon-user/images/sample-it.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="/neon-user/images/sample-au.png" alt="" class="pull-right op" />
...
<ul class="chat-history" id="sample_history_2">
	...
	<link rel="stylesheet" href="{{ asset('/neon-user/js/jvectormap/jquery-jvectormap-1.2.2.css') }}">
	<link rel="stylesheet" href="{{ asset('/neon-user/js/rickshaw/rickshaw.min.css') }}">

	<!-- Bottom scripts (common) -->
	<script src="{{ asset('/neon-user/js/gsap/main-gsap.js') }}"></script>
	<script src="{{ asset('/neon-user/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js') }}"></script>
	<script src="{{ asset('/neon-user/js/bootstrap.js') }}"></script>
	<script src="{{ asset('/neon-user/js/joinable.js') }}"></script>
	<script src="{{ asset('/neon-user/js/resizeable.js') }}"></script>
	<script src="{{ asset('/neon-user/js/neon-api.js') }}"></script>
	<script src="{{ asset('/neon-user/js/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>


	<!-- Imported scripts on this page -->
	<script src="{{ asset('/neon-user/js/jvectormap/jquery-jvectormap-europe-merc-en.js') }}"></script>
	<script src="{{ asset('/neon-user/js/jquery.sparkline.min.js') }}"></script>
	<script src="{{ asset('/neon-user/js/rickshaw/vendor/d3.v3.js') }}"></script>
	<script src="{{ asset('/neon-user/js/rickshaw/rickshaw.min.js') }}"></script>
	<script src="{{ asset('/neon-user/js/raphael-min.js') }}"></script>
	<script src="{{ asset('/neon-user/js/morris.min.js') }}"></script>
	<script src="{{ asset('/neon-user/js/toastr.js') }}"></script>
	<script src="{{ asset('/neon-user/js/neon-chat.js') }}"></script>


	<!-- JavaScripts initializations and stuff -->
	<script src="{{ asset('/neon-user/js/neon-custom.js') }}"></script>


	<!-- Demo Settings -->
	<script src="{{ asset('/neon-user/js/neon-demo.js') }}"></script>
