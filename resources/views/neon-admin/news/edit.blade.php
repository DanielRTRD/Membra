...
@section('title', 'Edit News - '.$article->title.' - Admin')
@section('css')
	<style>
	...
	<div class="col-md-12">
		...
		<form action="{{ route('admin-news-update', $article->id) }}" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control input-lg @if($errors->has('title')) has-error @endif" name="title" placeholder="Article title" value="{{ (old('title')) ? old('title') : $article->title }}" />
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-12">
					<textarea class="form-control wysihtml5 @if($errors->has('content')) has-error @endif" rows="18" data-stylesheet-url="{{ Theme::url('css/wysihtml5-color.css ') }}" name="content">
					...
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<div class="checkbox checkbox-replace">
								...
								<p class="text-warning"><small><em>Will be visible on the users dashboard if checked or not</em></small></p>
							</div>
				...
				<div class="col-sm-4">
					...
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<select name="categories[]" class="selectboxit">
