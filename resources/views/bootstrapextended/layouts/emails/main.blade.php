...
<title>{{ Config::get('rtech.appname') }}: @yield('subject')</title>
<style type="text/css">
		...
		<td class="container" width="600">
			<div class="content">
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td class="content-block">
										<img src="{{ Config::get('rtech.appprotocol') }}://{{ Config::get('rtech.appdomain') }}/img/logo_500.png"><br>
										<h2>@yield('subject')</h2>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="content-block">
										&mdash; {{ Config::get('rtech.appname') }} Crew
									</td>
								</tr>
							</table>
						</td>
				...
				<div class="footer">
					<table width="100%">
						<tr>
							<td class="aligncenter content-block"><a href="{{ Config::get('rtech.appprotocol') }}://{{ Config::get('rtech.appdomain') }}/">{{ Config::get('rtech.appdomain') }}</a></td>
						</tr>
					</table>
				</div></div>
		</td>
