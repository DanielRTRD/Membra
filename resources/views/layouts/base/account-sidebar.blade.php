<ul class="nav nav-pills nav-stacked">
	...
	<li @if(Request::is('account/change/images')){{'class="active"'}}@endif><a href="{{ route('account-change-images') }}"><span class="fa fa-picture-o"></span> Change profile picture</a></li>
